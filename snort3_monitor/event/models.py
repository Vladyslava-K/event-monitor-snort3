...
class Rule(models.Model):
    ...
    - gid (int): Generator ID - identifies the specific part of Snort that generated a given event.
    ...
    def save(self, *args, **kwargs):
        self.id = f"{self.gid}/{self.sid}/{self.rev}"
...
class Event(models.Model):
    ...
    src_addr = models.CharField(max_length=30, null=True, blank=True)
    src_port = models.IntegerField(null=True, blank=True)
    dst_addr = models.CharField(max_length=30, null=True, blank=True)
